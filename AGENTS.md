...
- The current user comes from `useCurrentUser()` — a **placeholder** until Task 4
...
- Add Bearer auth (Task 4) via `registerRequestInterceptor` — do not edit the
  client or generated code for it.
